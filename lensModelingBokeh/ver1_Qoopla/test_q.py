...
class AppForm(QMainWindow):
    ...
    def create_main_frame(self):
        self.main_frame = pg.GraphicsWindow()
        self.main_frame.setBackground('w')
        self.main_frame.setFixedSize(820, 700)

        self.sinc_plot = self.main_frame.addPlot(title='Sinc Function')
        ...
        # c = pg.IsocurveItem(level=0, pen=(3, 9))
        # c.setData(mua)
        ...
        self.cb_models.addItems(["SIE", "PIE", "TNFW", "TNFW+SIE", "PIEMD"])
