...
def optimize_pars(x1, x2, data, lpar_in, spar_in):
    ...
    initial_guess = (lpar_in[0],lpar_in[1],lpar_in[2],lpar_in[3],lpar_in[4],spar_in[0],spar_in[1],spar_in[2],spar_in[3],spar_in[4])
...
if __name__ == '__main__':
    ...
    lpar_in = initial_guess[:5]
    spar_in = initial_guess[5:]
